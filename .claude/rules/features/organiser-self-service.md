...
| `src/app/tournament-planner/share/[tournamentId]/page.tsx` | Branches between `getSuggestedOpenDates` and `getSuggestedSlotDates` based on the tournament's flag |
