...
| `src/app/unscheduled-availability/page.tsx` | Dedicated page — filters the 16-week horizon down to dates/slots with no existing booking; reachable via the "Matches ▾" nav sub-menu, not buried on `/fixtures` |
