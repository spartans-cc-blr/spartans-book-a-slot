...
#### `tournaments`
`id, name, organiser_name, organiser_contact, active, total_league_games, vc_captain_id, cricheroes_points_table_url, organiser_self_service, is_practice, intended_formats, created_at`
